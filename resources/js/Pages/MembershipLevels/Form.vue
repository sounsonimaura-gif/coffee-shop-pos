...
const form = useForm({
        ...
        min_spend: model.min_spend ?? 0,
        min_points: model.min_points ?? 0,
        discount_percent: model.discount_percent ?? 0,
        point_multiplier: model.point_multiplier ?? 1,
    ...
    >
        <form class="card" @submit.prevent="submit">
            ...
            <div class="card-body row">
                ...
                <FormField :label="t('price')" :error="form.errors.min_spend" :required="!!''">
                    <input v-model="form.min_spend" type="number" step="0.01" class="form-control" />
                </FormField>
                <FormField :label="t('quantity')" :error="form.errors.min_points" :required="!!''">
                    <input v-model="form.min_points" type="number" step="1" class="form-control" />
                </FormField>
                <FormField :label="t('discount')" :error="form.errors.discount_percent" :required="!!''">
                    <input v-model="form.discount_percent" type="number" step="0.01" class="form-control" />
                </FormField>
                <FormField :label="t('quantity')" :error="form.errors.point_multiplier" :required="!!''">
                    <input v-model="form.point_multiplier" type="number" step="0.01" class="form-control" />
                </FormField>
