...
const form = useForm({
        ...
        base_unit_multiplier: model.base_unit_multiplier ?? 1,
    ...
    >
        <form class="card" @submit.prevent="submit">
            ...
            <div class="card-body row">
                ...
                <FormField :label="t('code')" :error="form.errors.symbol" :required="!!''">
                    <input v-model="form.symbol" type="text" class="form-control" />
                </FormField>
                <FormField :label="t('quantity')" :error="form.errors.base_unit_multiplier" :required="!!''">
                    <input v-model="form.base_unit_multiplier" type="number" step="0.000001" class="form-control" />
                </FormField>
