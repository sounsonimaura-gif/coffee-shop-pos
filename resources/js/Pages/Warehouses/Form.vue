...
const form = useForm({
        ...
        warehouse_code: model.warehouse_code ?? null,
    ...
    >
        <form class="card" @submit.prevent="submit">
            ...
            <div class="card-body row">
                ...
                <FormField :label="t('code')" :error="form.errors.warehouse_code" :required="!!'required'">
                    <input v-model="form.warehouse_code" type="text" class="form-control" />
                </FormField>
