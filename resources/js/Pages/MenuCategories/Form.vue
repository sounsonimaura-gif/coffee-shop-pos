...
const form = useForm({
        ...
        show_on_pos: model.show_on_pos ?? true,
    ...
    >
        <form class="card" @submit.prevent="submit">
            ...
            <div class="card-body row">
                ...
                <FormField :label="t('slug')" :error="form.errors.slug" :required="!!''">
                ...
                <FormField :label="t('is_active')">
                    <div class="form-check form-switch">
                        <input v-model="form.show_on_pos" type="checkbox" class="form-check-input" :id="'switch-show_on_pos'" />
                        <label class="form-check-label" :for="'switch-show_on_pos'">{{ form.show_on_pos ? t('yes') : t('no') }}</label>
                    </div>
                </FormField>
