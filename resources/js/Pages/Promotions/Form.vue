...
const form = useForm({
        promo_code: model.promo_code ?? null,
    ...
    >
        <form class="card" @submit.prevent="submit">
            ...
            <div class="card-body row">
                ...
                <FormField :label="t('code')" :error="form.errors.promo_code" :required="!!''">
                    <input v-model="form.promo_code" type="text" class="form-control" />
                </FormField>
