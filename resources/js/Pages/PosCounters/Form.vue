...
const form = useForm({
        ...
        counter_code: model.counter_code ?? null,
        name: model.name ?? null,
        printer_name: model.printer_name ?? null,
        receipt_size: model.receipt_size ?? '80mm',
    ...
    >
        <form class="card" @submit.prevent="submit">
            ...
            <div class="card-body row">
                ...
                <FormField :label="t('code')" :error="form.errors.counter_code" :required="!!'required'">
                    <input v-model="form.counter_code" type="text" class="form-control" />
                </FormField>
                ...
                <FormField :label="t('receipt_size')" :error="form.errors.receipt_size" :required="!!''">
                    <TomSelectField v-model="form.receipt_size" :options='[{"value":"58mm","text":"58mm"},{"value":"80mm","text":"80mm"},{"value":"A4","text":"A4"}]' value-field="value" label-field="text" :placeholder="t('select_placeholder')" />
                </FormField>
