...
class CashierShiftsController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('CashierShifts/Index', [
            ...
            'columns' => [
                ['data' => 'shift_no', 'name' => 'shift_no', 'title' => 'coffee.code'],
                ['data' => 'opened_at', 'name' => 'opened_at', 'title' => 'coffee.from'],
                ['data' => 'closed_at', 'name' => 'closed_at', 'title' => 'coffee.to'],
                ['data' => 'opening_cash', 'name' => 'opening_cash', 'title' => 'coffee.opening_cash'],
                ['data' => 'closing_cash', 'name' => 'closing_cash', 'title' => 'coffee.closing_cash'],
                ['data' => 'total_sales', 'name' => 'total_sales', 'title' => 'coffee.total_sales'],
